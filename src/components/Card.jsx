...
export default function Card(props) {
  return (
    <div className={`${props.width} shrink-0 mb-3 relative`}>
      {props.onFavorite && (
        <button
          onClick={() => props.onFavorite(props)}
      ...
      <div className="group h-[182px] rounded-[15px] overflow-hidden relative">
        ...
        <div className="image-overlay absolute w-full h-full top-0 flex items-end p-2 text-[16px] md:text-[25px]
      ...
      <div className="text-slate-500">{props.cuisine}</div>
      <div>
        {props.name}
        <br />
        {props.place}
